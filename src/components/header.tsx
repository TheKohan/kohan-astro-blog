    ...
    <header className="py-4">
      <nav className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <a
            href="/"
            className="text-2xl font-bold text-kohan-900 !no-underline dark:text-slate-500"
          >
            <span>&lt;&nbsp;</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <a
              href="https://twitter.com/The_Kohan"
              target="_blank"
              aria-label="Kohan twitter account link"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="fill-kohan-800 duration-300 ease-in-out hover:scale-125 dark:fill-kohan-500"
                width="32px"
                height="32px"
              >
            ...
            <a
              href="https://github.com/TheKohan"
              target="_blank"
              aria-label="Kohan github account link"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
